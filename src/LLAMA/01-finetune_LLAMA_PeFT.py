...
# %%
# Load the tokenizer
tokenizer = AutoTokenizer.from_pretrained(MODEL_NAME, truncation_side="left", use_fast=True, token=hf_token, cache_dir = cache_location)
...
model = LlamaForCausalLM.from_pretrained(MODEL_NAME, quantization_config=bnb_config,
                                            device_map="auto", token=hf_token, cache_dir = cache_location)
